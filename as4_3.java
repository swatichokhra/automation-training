	...
	WebDriver driver;
		...
		System.out.println("No of items on page: " + n);
		        ...
		        for(int i=1;i<=n;i++)
		        {
		        	...
		        	//List<WebElement> checkboxItems=driver.findElements(By.xpath("//ul[@class='product_list row list']/li["+i+"]/div/div/div/ul[@class='color_to_pick_list clearfix']/li"));
		        	List<WebElement> checkboxItems = driver.findElements(By.cssSelector("ul.product_list .color-list-container ul li a"));
		        	int n1 = checkboxItems.size();
		    		System.out.println("No of checkboxitems on page: " + n1);
